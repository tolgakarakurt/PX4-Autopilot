...
{
	_ekf_params->VerticalHeightSensor_type = VerticalHeightSensor::BARO;
}
...
{
	_ekf_params->VerticalHeightSensor_type = VerticalHeightSensor::GPS;
}
...
{
	_ekf_params->VerticalHeightSensor_type = VerticalHeightSensor::RANGE;
}
...
{
	_ekf_params->VerticalHeightSensor_type = VerticalHeightSensor::EV;
}
